...
import com.biere.catalog.infrastructure.adapter.input.rest.dtos.BreweryRegistrationDTO
import com.biere.catalog.infrastructure.adapter.output.persistence.entity.CountryEntity
import com.biere.catalog.infrastructure.adapter.output.persistence.repository.BreweryRepository
...
import com.biere.catalog.infrastructure.adapter.input.rest.dtos.BreweryUpdateRequestDTO
...
class BreweryControllerIT(
    ...
    fun `register brewery, when blank name should return bad request`(){
        ...
        webTestClient
            ...
            .jsonPath("$.invalid-params[0].reason").isEqualTo("The name of the brewery can not be empty")
    }
