...
class BeerControllerIT(
    ...
    fun setup(){
        ...
        newBeer = BeerRegistrationDTO(name = "Heineken", countryId = savedCountry.id ?: 0, alcoholContent = 4.5F, breweryId = brewery.id ?: 0)
    }
    ...
    fun `register beer`(){
        webTestClient
            ...
            .expectBody(BeerRegistrationResponseDTO::class.java)
